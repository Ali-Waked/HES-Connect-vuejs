...
<template>
  <div v-if="images.length > 0" class="space-y-3">
    <div class="relative group rounded-xl overflow-hidden border border-landing-border shadow-sm">
      <Swiper
      ...
      >
        <SwiperSlide v-for="(img, i) in images" :key="i">
          <div
            class="w-full bg-slate-100 cursor-pointer"
            :class="aspectRatio"
      ...
      <button
        class="swiper-prev absolute left-3 top-1/2 -translate-y-1/2 z-10 w-10 h-10 rounded-xl bg-white/90/90 backdrop-blur-sm shadow-md flex items-center justify-center text-slate-700 hover:bg-white transition opacity-0 group-hover:opacity-100 cursor-pointer"
      >
      ...
      <button
        class="swiper-next absolute right-3 top-1/2 -translate-y-1/2 z-10 w-10 h-10 rounded-xl bg-white/90/90 backdrop-blur-sm shadow-md flex items-center justify-center text-slate-700 hover:bg-white transition opacity-0 group-hover:opacity-100 cursor-pointer"
      >
  ...
  <div v-else class="rounded-xl border border-landing-border bg-gradient-to-br from-slate-100 to-slate-200 flex items-center justify-center" :class="aspectRatio">
