  ...
  <section class="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm sm:p-6">
    ...
    <form class="mt-6 grid grid-cols-1 gap-5 sm:grid-cols-2" @submit.prevent="save">
      <label class="space-y-2">
        ...
        <input v-model="form.fullName" :disabled="!editMode" class="w-full rounded-lg border border-slate-200 px-3 py-2.5 text-sm font-medium outline-none transition disabled:bg-slate-50 disabled:text-slate-600 " />
      ...
      <label class="space-y-2">
        ...
        <input v-model="form.email" type="email" :disabled="!editMode" class="w-full rounded-lg border border-slate-200 px-3 py-2.5 text-sm font-medium outline-none transition disabled:bg-slate-50 disabled:text-slate-600 " />
      ...
      <label class="space-y-2">
        ...
        <input v-model="form.phone" :disabled="!editMode" class="w-full rounded-lg border border-slate-200 px-3 py-2.5 text-sm font-medium outline-none transition disabled:bg-slate-50 disabled:text-slate-600 " />
      ...
      <label class="space-y-2">
        ...
        <input v-model="form.birthDate" type="date" :disabled="!editMode" class="w-full rounded-lg border border-slate-200 px-3 py-2.5 text-sm font-medium outline-none transition disabled:bg-slate-50 disabled:text-slate-600 " />
      </label>
