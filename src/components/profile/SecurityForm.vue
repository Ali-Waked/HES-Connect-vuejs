    ...
    <section class="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm sm:p-6">
      ...
      <form class="mt-6 grid grid-cols-1 gap-5" @submit.prevent="submit">
        <label class="space-y-2">
          ...
          <input v-model="form.currentPassword" type="password" autocomplete="current-password" class="w-full rounded-lg border border-slate-200 bg-white px-3 py-2.5 text-sm font-medium text-slate-900 outline-none transition " />
        ...
        <div class="grid grid-cols-1 gap-5 sm:grid-cols-2">
          <label class="space-y-2">
            ...
            <input v-model="form.newPassword" type="password" autocomplete="new-password" class="w-full rounded-lg border border-slate-200 bg-white px-3 py-2.5 text-sm font-medium text-slate-900 outline-none transition " />
          ...
          <label class="space-y-2">
            ...
            <input v-model="form.confirmPassword" type="password" autocomplete="new-password" class="w-full rounded-lg border border-slate-200 bg-white px-3 py-2.5 text-sm font-medium text-slate-900 outline-none transition " />
