    ...
    <div class="relative px-5 pb-6 pt-0 sm:px-8">
      <div class="-mt-14 flex flex-col gap-5 sm:-mt-16 sm:flex-row sm:items-end sm:justify-between">
        <div class="flex flex-col gap-4 sm:flex-row sm:items-end">
          <div class="relative h-28 w-28 rounded-2xl border-4 border-white bg-white shadow-xl sm:h-32 sm:w-32">
          ...
          <div class="pb-1">
            ...
            <template v-else>
              <div class="flex flex-wrap items-center gap-3">
                <h1 class="text-2xl font-semibold tracking-tight text-slate-950 sm:text-3xl">{{ profile.fullName }}</h1>
