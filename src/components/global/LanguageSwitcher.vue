  ...
  <div ref="dropdownRef" class="relative">
    ...
    >
      ...
      <svg
        ...
        :class="[open ? 'rotate-180' : '', overlay ? 'text-white/60' : 'text-slate-400']"
    ...
    >
      <div
        v-if="open"
        class="absolute right-0 mt-2 w-36 bg-white rounded-xl shadow-xl shadow-slate-900/10 border border-slate-200 py-1 overflow-hidden z-50"
      >
        <button
