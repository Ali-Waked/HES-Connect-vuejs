...
<template>
  <main class="min-h-screen bg-slate-50 px-4 py-8 text-slate-900 sm:px-6 lg:px-8 dark:bg-slate-950 dark:text-slate-100">
    <div class="mx-auto flex min-h-[calc(100vh-4rem)] w-full max-w-md flex-col justify-center">
      <router-link to="/" class="mb-8 inline-flex items-center gap-3 self-center">
        ...
        <span class="text-left">
          <span class="block text-sm font-semibold tracking-tight text-slate-950 dark:text-white">Health Ecosystem</span>
          <span class="block text-xs font-medium text-slate-500 dark:text-slate-400">Management System</span>
        </span>
      </router-link>

      <section class="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm sm:p-8 dark:border-slate-800 dark:bg-slate-900">
        <header class="mb-7">
