  ...
  <div>
    ...
    <div class="relative">
      <input
        ...
        :disabled="disabled"
        class="block w-full rounded-xl border bg-white px-4 py-3 pe-11 text-sm text-slate-900 placeholder-slate-400 transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-brand-primary/20 focus:border-brand-primary disabled:opacity-50 disabled:cursor-not-allowed"
        :class="error ? 'border-red-300 focus:ring-red-200 focus:border-red-400' : 'border-slate-200 hover:border-slate-300'"
