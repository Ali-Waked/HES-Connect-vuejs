...
<template>
  <LandingSection v-if="announcements.length > 0" class="py-6 bg-amber-50/30 border-y border-amber-100/50 dark:bg-amber-950/30 dark:border-amber-900/50">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      >
        <div class="w-10 h-10 shrink-0 bg-amber-100/50 rounded-xl flex items-center justify-center text-amber-600 dark:bg-amber-900/50 dark:text-amber-400">
