...
const typeBadge = {
  ...
  medical_point: 'bg-orange-100 text-orange-700'
};
  ...
  <LandingSection class="py-16 lg:py-20 bg-landing-warm">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="flex items-center justify-between mb-8">
        <h2 class="text-2xl sm:text-3xl font-bold text-slate-900">Latest Job Opportunities</h2>
        ...
        >
          <div class="flex-1 min-w-0 space-y-2">
            <div class="flex flex-wrap items-center gap-2">
              <span class="text-sm font-semibold text-slate-700">{{ job.facility_name }}</span>
