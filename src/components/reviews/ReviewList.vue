...
<template>
  <div class="space-y-4">
    ...
    <div v-else-if="reviews.length === 0" class="text-center py-12">
      <svg class="w-12 h-12 mx-auto text-slate-300 dark:text-slate-500 mb-3" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
      ...
      <p class="text-sm font-semibold text-slate-400 dark:text-slate-500">No reviews yet</p>
      <p class="text-xs text-slate-300 dark:text-slate-500 mt-1">Be the first to share your experience</p>
    </div>
