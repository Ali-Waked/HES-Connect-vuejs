...
<template>
  <div v-if="article" class="max-w-4xl mx-auto space-y-6 animate-fade-in">
    ...
    <nav class="flex items-center gap-2 text-sm font-medium text-slate-500 dark:text-slate-400 mb-2">
      ...
      <span class="text-slate-900 dark:text-slate-100 truncate max-w-[200px]">{{ article.title }}</span>
    </nav>
          ...
          <div class="flex flex-wrap items-center gap-y-3 gap-x-6 pt-2 border-t border-slate-100 dark:border-slate-700 mt-6">
            <div class="flex items-center gap-2.5">
              ...
              <div class="flex flex-col">
                ...
                <span class="text-sm font-bold text-slate-900 dark:text-slate-100">{{ article.author }}</span>
              </div>
            </div>
            ...
            <div class="flex items-center gap-2.5">
              ...
              <div class="flex flex-col">
                ...
                <span class="text-sm font-bold text-slate-900 dark:text-slate-100">{{ article.publish_date || 'Not Published' }}</span>
              </div>
            </div>
            ...
            <div class="flex items-center gap-2.5">
              ...
              <div class="flex flex-col">
                ...
                <span class="text-sm font-bold text-slate-900 dark:text-slate-100">{{ article.views.toLocaleString() }}</span>
              </div>
            </div>
          </div>
        </div>
