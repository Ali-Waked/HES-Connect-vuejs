  ...
  <div class="space-y-6 animate-fade-in">
    ...
    <div class="flex flex-col sm:flex-row gap-3">
      <div class="relative flex-grow">
        ...
        <input type="text" v-model="searchQuery" class="w-full pl-10 pr-4 py-2.5 text-sm border border-slate-200 rounded-lg bg-white placeholder-slate-400 focus:outline-none transition" placeholder="Search jobs, facilities, authors..."/>
      </div>
