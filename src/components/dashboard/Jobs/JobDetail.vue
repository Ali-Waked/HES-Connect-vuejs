      ...
      <div class="p-8 space-y-6">
        <div class="space-y-4">
          ...
          <div class="flex flex-wrap items-center gap-y-3 gap-x-6 pt-2 border-t border-slate-100 dark:border-slate-700 mt-6">
            ...
            <div class="flex items-center gap-2.5">
              ...
              <div class="flex flex-col">
                <span class="text-[10px] font-bold text-slate-400 dark:text-slate-500 uppercase tracking-widest">Deadline</span>
        ...
        <div class="bg-slate-50 dark:bg-slate-900 rounded-xl p-6 border border-slate-100 dark:border-slate-700 mt-8">
          ...
          <div class="flex items-center gap-3">
            <span class="text-sm text-slate-500 dark:text-slate-400 font-medium">Please apply via {{ job.apply_method }}:</span>
            <a 
