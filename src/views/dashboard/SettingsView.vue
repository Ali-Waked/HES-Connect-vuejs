      ...
      <div class="space-y-4">
        <div>
          ...
          <input
            ...
            v-model="name"
            type="text"
            class="w-full px-4 py-2.5 text-sm border border-slate-200 rounded-lg bg-white focus:outline-none focus:border-brand-primary focus:ring-3 focus:ring-brand-primary/10 transition"
          />
        </div>
