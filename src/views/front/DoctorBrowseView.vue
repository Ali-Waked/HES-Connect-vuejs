    ...
    <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-14 pt-28 lg:pt-32">
      <div data-aos="fade-up">
        ...
        <div class="max-w-2xl mb-10">
          <h1 class="text-3xl sm:text-4xl font-bold text-slate-900 dark:text-slate-100 tracking-tight">Our Doctors</h1>
      ...
      <div v-else-if="doctors.length === 0" class="text-center py-20 text-slate-500 dark:text-slate-400">
      ...
      <div v-else class="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
        <div
          ...
          class="bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 p-6 shadow-sm hover:shadow-md hover:-translate-y-0.5 hover:border-brand-primary/20 transition-all duration-200 text-center"
        >
